...
const NavRight = () => {
  const navigate = useNavigate(); // Hook để điều hướng người dùng sau khi đăng xuất
  ...
  const handleLockOut = () => {
    ...
    // Sau khi reload, chuyển hướng người dùng đến trang login
    setTimeout(() => {
      navigate('/login');
    }, 500); // Delay để đảm bảo reload hoàn tất trước khi điều hướng
  };
